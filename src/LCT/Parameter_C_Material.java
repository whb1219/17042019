...
//		double	H_Painting_O=0;
		...
		double La_Cutting_hull=0; //labour cost
		double La_Bending_hull=0;
		double La_Blasting_hull=0;
		double La_Welding_hull=0;
		double La_Painting_hull=0;
...
//		double L_Painting_O=0;
		...
		double r_bending=30;
		double r_welding=40;
		double r_blasting=4.5;
		double r_painting=10.5;
		
		public void run(){
			//Interim results
			if(W1==0) {
			 W11 = 0.00072*Math.pow(Cb,0.333333)*Math.pow(LBP,2.5)*T*B/D;
			 W12 = 0.011*LBP*B*D;
			 W13 = 0.0198*LBP*B*D;
			 W14 = 0.0388*LBP*B*NJ;
			 W15 = 0.00275*LBP*B*D;
...
//			System.out.println(W1);
			...
			double W23 = 0.0001185*LBP*T*Math.sqrt(Vs);
			double W24 = (0.00883+0.002029)*LBP*B*D;
			double W25 = 0.002325*LBP*B*D;
			double W26 = 0.116*LBP*B;
			double W27 = 0.871*NE;
			double W29 = 0.0000845*LBP*B*D;
			 W2 = W21+W22+W23+W24+W25+W26+W27+W29;
			
			double M1 = LBP*B*D/1000;
			double M2 = 0.22*LBP*B*NJ/100;
...
//			L_Painting_hull = Labour_fee_painting*H_Painting_Hull;}
			...
			H_Cutting_Hull = W11*r_cutting;
			H_Bending_Hull = W11*r_bending;
			H_Welding_Hull = W11*r_welding;
			H_Blasting_Hull = W11*r_blasting;
			H_Painting_Hull = W11*r_painting;
...
//			System.out.println("E5"+E_Painting_hull);
			...
			La_Cutting_hull = Labour_fee_cutting*H_Cutting_Hull;
			La_Bending_hull = Labour_fee_bending*H_Bending_Hull;
			La_Blasting_hull = Labour_fee_blasting*H_Blasting_Hull;
			La_Welding_hull = Labour_fee_welding*H_Welding_Hull;
			La_Painting_hull = Labour_fee_painting*H_Painting_Hull;
					//================================		
//			if(H_Cutting_O == 0) {
...
//			System.out.println("PE"+Processing_energy);
			...
			Labour_cost = La_Cutting_hull+La_Bending_hull+La_Blasting_hull+La_Welding_hull+La_Painting_hull;
